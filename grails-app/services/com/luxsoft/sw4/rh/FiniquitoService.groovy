...
class FiniquitoService {
    ...
    def save(Finiquito finiquito){
        ...
        finiquito.addToPartidas(tipo: 'PERCEPCION', importeGravado:finiquito.primaDominicalGravada, importeExcento:finiquito.primaDominicalExenta, concepto: ConceptoDeNomina.get(42), finiquito: false);
