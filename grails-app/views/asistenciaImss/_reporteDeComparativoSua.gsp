...
<div class="modal fade" id="reporteDeComparativoSua" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"
					aria-hidden="true">&times;</button>
				<h4 class="modal-title" id="myModalLabel">Comparativo SUA </h4>
			</div>
...
<%--    						<g:field type="text" name="FECHA_INI" class="form-control"/>	--%>
					...
					<div class="form-group">
	  				...
	  				<div class="form-group">
	    				...
	    				<select property='Tipo' name="TIPO">
							<option value="D.FECHA ">FECHA</option>
							<option value="D.CAMBIO">CAMBIO</option>
						</select>
					</div>				
