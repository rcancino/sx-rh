			...
			<div class="col-md-9">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">Subsidio ${subsidioEmpleoInstance.id}</h3>
					</div>
					<div class="panel-body">	
						...
						<g:form action="update" 
							...
							<f:with bean="subsidioEmpleoInstance">
								<g:hiddenField name="id" value="${subsidioEmpleoInstance.id}"/>
								<g:hiddenField name="version" value="${subsidioEmpleoInstance.version}"/>
