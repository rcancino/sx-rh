...
<head>
	...
	<title>${bancoSatInstance.clave}</title>
</head>
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="page-header">
				  <h1>${bancoSatInstance.nombreCorto}<p><small>${session.empresa}</small></p>
		...
		<div class="row ">
			...
			<div class="col-md-6 col-md-offset-3">
				...
				<g:form class="form-horizontal" action="update" id="${bancoSatInstance.id}" method="PUT">	
