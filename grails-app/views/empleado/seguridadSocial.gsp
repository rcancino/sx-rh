	...
	<div class="row wrapper border-bottom white-bg page-heading">
	    <div class="col-lg-10">
	        ...
	        <ol class="breadcrumb">
        	    ...
        	    <li><g:link action="seguridadSocial" id="${empleadoInstance.id}"><strong>Seguridad social</strong></g:link></li>
		...
		<div class="col-md-12">
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					<div class="row">
						<g:render template="seguridadSocialForm"/>
					</div>
				...
				<div class="ibox-footer">
					...
					<g:if test="${!edit}">
						...
						<g:link class="btn btn-default btn-outline" 
							action="seguridadSocial" id="${empleadoInstance.id}" params="[edit:'true']">Modificar</g:link>
