	...
	<div class="row wrapper border-bottom white-bg page-heading">
	    <div class="col-lg-10">
	        ...
	        <ol class="breadcrumb">
        	    ...
        	    <li><g:link action="datosPersonales" id="${empleadoInstance.id}"><strong>Datos personales</strong></g:link></li>
	...
	<div class="row wrapper wrapper-content animated fadeInRight">
		<div class="col-md-12">
			<div class="ibox float-e-margins">
				<lx:iboxTitle title="Información personal"/>
				<div class="ibox-content">
					<div class="row">
						<g:render template="datosPersonalesForm"/>
					</div>
				...
				<div class="ibox-footer">
					...
					<g:if test="${!edit}">
						...
						<g:link class="btn btn-default btn-outline" 
							action="datosPersonales" id="${empleadoInstance.id}" params="[edit:'true']">Modificar</g:link>
