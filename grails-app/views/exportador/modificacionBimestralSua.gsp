...
<title>Aviso de Modificacion Bimestral de Salario</title>
</head>
<body>

	<content tag="reporteTitle">
		Aviso de Modificacion Bimestral de Salario
	</content>
	<content tag="reportForm">
		...
		<g:form action="generarModificacionBimestralSua" class="form-horizontal">
