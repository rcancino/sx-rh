...
<title>Aviso de Modificacion Individual SUA</title>
</head>
<body>

	<content tag="reporteTitle">
		Aviso de Modificacion Individual SUA
	</content>
	<content tag="reportForm">
		...
		<g:form action="generarModificacionIndividualSua" class="form-horizontal">
