...
<div class="modal fade" id="reporteDeNominaConcentradaForm" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"
					aria-hidden="true">&times;</button>
				<h4 class="modal-title" id="myModalLabel">Reporte Nómina Concentrada</h4>
			</div>
			<div class="modal-body">
				<g:form controller='reporte' action="nominaConcentrada" class="form-horizontal">
					<fieldset>
