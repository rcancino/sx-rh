	...
	<content tag="grid">
		<div class="panel panel-default">
			<div class="panel-heading">
				Verifique datos de salario para : ${nominaEmpleado?.empleado?.nombre} 
			</div>
			<div class="panel-body">
				<g:hasErrors bean="${salario}">
            		<div class="alert alert-danger">
                		<g:renderErrors bean="${salario}" as="list" />
            		</div>
        		</g:hasErrors>
				...
				<g:form class="form-horizontal " >
					...
					<div class="form-group ${hasErrors(bean:salario,field:'salarioDiario','has-error has-feedback') }">
						...
						<div class="col-sm-4">
							<g:field name="salarioDiarioIntegrado" type="number" value="${salario.salarioDiarioIntegrado}" required="" autofocus=""/>
