...
class RevisionCalculoExport {
	...
	String query="""SELECT E.id,E.clave,CONCAT(ifnull(E.apellido_paterno,'')," ",ifnull(E.apellido_materno,'')," ",E.nombres) AS nombre,P.numero_de_trabajador,E.alta,e.status,(SELECT b.fecha FROM baja_de_empleado b where b.empleado_id=e.id) as baja,(SELECT U.descripcion FROM ubicacion U WHERE p.UBICACION_ID=U.ID) AS ubicacion,s.periodicidad,cl.salario,cl.id,cl.ejercicio ,cl.ingreso_total,cl.proyectado,cl.total_gravado,cl.subs_emp_aplicado,cl.isr,cl.compensacionsaf,cl.impuesto_del_ejercicio,cl.impuesto_del_ejercicio-cl.subs_emp_aplicado as isrMenosSPEAplic,cl.resultado,cl.sueldo,cl.comisiones,cl.vacaciones,cl.vacaciones_pagadas,cl.prima_vacacional_exenta,cl.prima_vacacional_gravada,cl.incentivo,cl.aguinaldo_exento,cl.aguinaldo_gravable,cl.indemnizacion_exenta,cl.indemnizacion_gravada,cl.prima_de_antiguedad_exenta,cl.prima_de_antiguedad_gravada,cl.compensacion,cl.ptu_exenta,cl.ptu_gravada,cl.bono_de_productividad,cl.bono_por_desempeno,cl.bono,cl.bono_antiguedad,cl.devispt,cl.prima_dominical_exenta,cl.prima_dominical_gravada,cl.gratificacion,cl.permiso_por_paternidad,cl.tiempo_extra_doble_exento,cl.tiempo_extra_doble_gravado,cl.tiempo_extra_triple_gravado,cl.subs_emp_pagado,cl.total_exento,cl.total_gravado,cl.total,cl.ingreso_total,cl.retardos,cl.proyectado,cl.subs_emp_aplicado,cl.isr,cl.impuesto_del_ejercicio,cl.resultado,cl.devisptant,cl.compensacionsaf,cl.calculo_anual  
